...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/cart_with_item.svg
  SvgGenImage get cartWithItem =>
      const SvgGenImage('assets/images/cart_with_item.svg');
  ...
  /// File path: assets/images/shopping-bag.svg
  SvgGenImage get shoppingBag =>
      const SvgGenImage('assets/images/shopping-bag.svg');

  /// List of all assets
  List<SvgGenImage> get values =>
      [back, cartWithItem, chat, notification, search, shoppingBag];
}
